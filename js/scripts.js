(function () {
    ...
    function checkDifference() {
        ...
        console.log(playerOneDifference);
        console.log(playerTwoDifference);
    ...
    function checkScore() {
         if (outputPlayerOne.value > blackJack && outputPlayerTwo.value <= blackJack) {
            reset();
            playerTwoMainScore.value++;
        } else if (outputPlayerOne.value <= blackJack && outputPlayerTwo.value > blackJack) {
            reset();
            playerOneMainScore.value++;
            ...
            reset();
        } else if (buttonPlayerOne.disabled === true && buttonPlayerTwo.disabled === true){
                checkDifference();
        } else return;
    }
    ...
    stopButtonPlayerOne.addEventListener("click", function(){
    ...
    stopButtonPlayerTwo.addEventListener("click", function(){
